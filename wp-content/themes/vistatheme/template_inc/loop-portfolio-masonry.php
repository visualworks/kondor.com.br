                    ...
                    <?php 
                        ...
                        if(count($categories) > 0){ 
                            foreach($categories as $cat):
                                            ...
                                            $cats .= '<li class="other"><a href="#" data-filter=".'.$cat->category_nicename.'">'.$cat->cat_name.'</a></li>';    
                                            $cats_p .= $cat->category_nicename.' ';
                            endforeach;
                            
                                echo '<!-- Portfolio Filter --><nav id="portfolio-filter" class="portfolio-item masonry_filter '.$cats_p.'"><div class="content">';
                                    ...
                                    echo '<p>'.$themeple_config['current_portfolio']['masonry_desc'].'</p>';
                                echo '</div></nav>';
                        } ?>
                                       ...
                                       <div class="overlay he-view">
                                            ...
                                            <div class="bg a0" data-animate="fadeIn">
                                                ...
                                                <div class="center-bar v1">
                                                    ...
                                                    <a href="<?php echo themeple_image_by_id(get_post_thumbnail_id(), array("width"=> 1200, "height" => 1200), "url") ?>" class="link a0 lightbox-gallery lightbox" data-animate="zoomIn"><i class="moon-search-3"></i></a>

                                                    <a href="<?php echo get_permalink() ?>" class="link a0" data-animate="zoomIn"><i class="moon-link-4"></i></a>
