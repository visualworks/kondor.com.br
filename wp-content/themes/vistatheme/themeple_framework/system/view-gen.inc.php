    ...
    class themeple_viewgen{
       ...
       var $used_for = 'admin_page';
		...
		{	
            ...
            }else if($element['subtype'] == 'selected_fonts'){
                $first = themeple_get_option('font_headings');
                $second = themeple_get_option('font_headings_dif');
                $entries['Default'] = 'default';
                if($first != '')
                    $entries[ucfirst($first)] = $first;
                if($second != '')
                    $entries[ucfirst($second)] = $second;
