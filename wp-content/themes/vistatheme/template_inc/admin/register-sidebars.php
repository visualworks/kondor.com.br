...
if(function_exists('register_sidebar')){
    ...
    register_sidebar(array(
    		...
    		'after_widget' => '</div>', 
    		'before_title' => '<div class="widget-title-container"><h6 class="widget-title">', 
    		'after_title' => '</h6><span class="colore_div"></span></div>'
    ));
    ...
    register_sidebar(array(
            'name' => __('Bbpress Sidebar', 'themeple'),
            'before_widget' => '<div id="%1$s" class="widget %2$s">', 
    		'after_widget' => '</div>', 
    		'before_title' => '<div class="widget-title-container"><h6 class="widget-title">', 
    		'after_title' => '</h6><span class="colore_div"></span></div>'
    ...
    register_sidebar(array(
            'name' => __('Copyright Footer Sidebar', 'themeple'),
            'before_widget' => '<div id="%1$s" class="widget %2$s">', 
    		'after_widget' => '</div>', 
    		'before_title' => '', 
    		'after_title' => ''
