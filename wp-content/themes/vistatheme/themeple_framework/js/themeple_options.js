...

{
...

	{
...

		{
            ...
            saveData.createButton.unbind('click').live('click', {set: saveData}, methods.add); 

			saveData.removeButton.unbind('click').live('click', {set: saveData}, methods.remove); 
...

{
	...
	{	
		...
		this.on('themeple_event_binding', function(event, element)
