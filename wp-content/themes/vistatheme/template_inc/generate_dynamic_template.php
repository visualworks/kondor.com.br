...
class GenerateDynamicTemplate{
        ...
        foreach($this->template_elements as $element)
		{
			...
			{			
                ...
                if(isset($element['saved']))
				{
                    ...
                    $i++;
                    if($i == 1 && ($element['dynamic'] == 'section_start' || ($element['dynamic'] == 'google_map' && $element['saved'][0]['map_fullwidth'] == 'yes') || $element['dynamic'] == 'fullwidth_portfolio' || ($element['dynamic'] == 'slideshow' && $element['saved'][0]['fullwidth'] == 'yes')  )){
			...
			if($i == count($this->template_elements) && ($element['dynamic'] == 'section_end' || ($element['dynamic'] == 'google_map' && $element['saved'][0]['map_fullwidth'] == 'yes') ||  ($element['dynamic'] == 'slideshow' && $element['saved'][0]['fullwidth'] == 'yes') || $element['dynamic'] == 'fullwidth_portfolio'  ) ){
				...
				if(!update_option('section_last', 'no') )
                    ...
                    if($element['dynamic'] == 'section_start'){
                            ...
                            if(isset($element['saved'][0]['inset_shadow']) && $element['saved'][0]['inset_shadow'] == 'yes'){
                                $other_class .= ' inset_shadow';
                                if(isset($element['saved'][0]['inset_shadow_color']) )
                                    $other_class .= ' inset_type_'.$element['saved'][0]['inset_shadow_color'];
                            }
                            if($element['saved'][0]['bg_type'] == 'bg_color')
                             ...
                             if(isset($element['saved'][0]['parallax']) && $element['saved'][0]['parallax'] == 'yes' && $element['saved'][0]['bg_type'] == 'image'){    
                                    ...
                                    $parallax .= '<div class="parallax_bg" data-type="background" style="background-image: url('.$element['saved'][0]['image'].'); background-position: 50% 0px;"></div>';
                             ...
                             if(isset($element['saved'][0]['padding_top']))
                                $other_style .= 'padding-top:'.$element['saved'][0]['padding_top'].'px !important; ';
                             if(isset($element['saved'][0]['padding_bottom']))
                                $other_style .= 'padding-bottom:'.$element['saved'][0]['padding_bottom'].'px !important; ';
					        $section_start = true;
                    }
                if( ($size == 0 && $element['dynamic'] != 'section_end') ){
                        

                        if( ($element['dynamic'] != 'google_map'  && $element['dynamic'] != 'fullwidth_portfolio' && $element['dynamic'] != 'slideshow' ) || ($element['dynamic'] == 'google_map' && $element['saved'][0]['map_fullwidth'] == 'no') || ($element['dynamic'] == 'slideshow' && $element['saved'][0]['fullwidth'] == 'no')  ){
                            ...
                            $this->output[] = '<div class="row-fluid row-dynamic-el animate_onoffset '.$other_class.'"'.$test.' '.$other_html.' style="'.$other_style.'">';
                                    if(isset($parallax))
                        ...
                        }else if(  ($element['dynamic'] == 'google_map' && $element['saved'][0]['map_fullwidth'] == 'yes') ||  ($element['dynamic'] == 'slideshow' && $element['saved'][0]['fullwidth'] == 'yes') || $element['dynamic'] == 'fullwidth_portfolio'){
                             $this->output[] = '<div class="row-fluid section-style row-dynamic-el" style="padding-top:0px;padding-bottom:0px;">';
                        }
                    ...
                    if($size == 12 && $element['dynamic'] != 'section_start'){
                        if( ($element['dynamic'] != 'slideshow' || ($element['dynamic'] == 'slideshow' && $element['saved'][0]['fullwidth'] == 'no') ) && ($element['dynamic'] != 'google_map' || ($element['dynamic'] == 'google_map' && $element['saved'][0]['map_fullwidth'] == 'no') ) && $element['dynamic'] != 'fullwidth_portfolio' ){           
                            ...
                            $this->output[] = '</div>';
                        }else if( $element['dynamic'] == 'fullwidth_portfolio' || ($element['dynamic'] == 'google_map' && $element['saved'][0]['map_fullwidth'] == 'yes') || ($element['dynamic'] != 'google_map' || ($element['dynamic'] == 'slideshow' && $element['saved'][0]['fullwidth'] == 'yes') )  ){
                            $this->output[] = '</div>';
                        }
                        $size = 0;
                    }
    ...
    function carousel_testimonial($element){
        extract($element['saved'][0]);
        $output = ''; 
        
        $output = '<div class="span'.$dynamic_size.' carousel_testimonial_el">';
        if(!empty($title)){
            $output .= '<div class="header"><h6>'.$title.'</h6><span class="colored_div"></span></div>';
        }
        ...
        $loop = new WP_Query($query_post);
                     if($loop->have_posts()){
                        ...
                        while($loop->have_posts()){
                            ...
                            $small_title = themeple_post_meta(get_the_ID(), 'small_title');
                            $bg = themeple_get_option('testimonial_bg_color');
                            $border = themeple_get_option('testimonial_border_color');
                            $extra_style = '';
                            $extra_style_2 = '';
                            if($background_color != 'default')
                                $bg = $baackground_color;
                            if($border_color != 'default')
                                $border = $border_color;
                            if($font_color != 'default'){
                                $extra_style .= 'color:'.$font_color.'; ';
                                $extra_style_2 .= 'color:'.$font_color.'; ';
                            }
                            $extra_style .= 'background-color:'.$bg.'; ';
                            $extra_style .= 'border:1px solid '.$border.'; ';
                            $output .= '<div class="single_testimonial_el"><div class="single_testimonial" style="'.$extra_style.'">';
                                if($small_title != '')
                                    $output .= '<h6>'.$small_title.'</h6>';
                                $output .= '<p class="content">'.get_the_content().'</p>';
                            $output .= '<div class="triangle"><div class="triangle_container" style="border-color: '.$border.' transparent transparent transparent;"><div class="triangle_trick" style="border-color: '.$bg.' transparent transparent transparent;"></div></div></div></div>';
                            $output .= '<dl class="dl-horizontal"><dt><img src="'.themeple_image_by_id(get_post_thumbnail_id(), 'little_square', 'url').'" alt=""></dt><dd><h5 style="'.$extra_style_2.'">'.get_the_title().'</h5><span class="position" style="'.$extra_style_2.'">'.themeple_post_meta(get_the_ID(), 'staff_position_').'</span></dd></dl></div>';
        ...
        $output .= '</div>';
        $output .= '<div class="pagination_wrapper"><div class="pagination"></div></div>';
        $output .= '</div></div>';
        return $output;
    }
    ...
    function clients($element){
        ...
        $output .= '    <h6>'.$title.'</h6><span class="colored_div"></span>';
        if($carousel == 'yes')
        ...
        if(!empty($clients)):
            foreach($clients as $client):                            
                    ...
                    if($i == 5 && $carousel == 'no' && $dynamic_size != 6)
                        break;
            endforeach;
        endif;                  
        $output .= '</section>';
            ...
            $output .= '<div class="span12 contact_info">';
                ...
                $output .= '<ul class="social_icons">';
                    foreach($social_icons as $icon):
                        ...
                        $output .= '<li class="'.$icon['social'].'"><a href="'.$icon['link'].'" target="_blank"><i class="icon-'.$icon['social'].'"></i></a></li>';
    ...
    function latest_blog($element){
        ...
        $output .= '<div class="header">';
            $output .= '<h6>'.$dynamic_title.'</h6><span class="colored_div"></span>';
            $output .= '<div class="pagination"></div>';
        $output .=  '</div>';
            ...
            $count = 0;
                              ...
                              if($i == 1)
                                $active = 'active'; 
                                                ...
                                                if($gradient_bool == 'yes' && $post_format != 'audio' && $post_format != 'gallery'){    
                                                ...
                                                if($post_format == 'audio'){
                                                    ...
                                                    $output .= $video;
                                                                ...
                                                                $output .= '<img src="'.themeple_image_by_id(get_post_thumbnail_id(), 'recent_blog', 'url').'" alt="">';
                                ...
                                $output .= '<h3><a href="'.get_permalink().'">'.themeple_text_limit(get_the_title(), 7).'</a></h3>';
                                                
                                $cat = get_the_category();
                                   
                                $output .= '<ul class="info">';
                                $output .= '<li class="icon_li"><span class="icon_blog '.$post_format.'"></span></li>';
                                $output .= '<li>'.get_the_date().'</li>';
                                $output .= '<li>'.$cat[0]->name.'</li>';
                                $output .= '<li>'.$count.' '.__('Comments', 'themeple').'</li>';
                                $output .= '</ul>';                
                                if($excerpt_bool == 'yes'){
                                    $output .= '<div class="blog_content">'.themeple_text_limit(get_the_excerpt(), 25).'</div>';
                                }
...
function latest_blog_filter($element){
        extract($element['saved'][0]);
        ...
        $output = '<div class="span'.$dynamic_size.' latest_blog_filter">';
        $output .= '<div class="header">';
            $output .= '<h6>'.$dynamic_title.'</h6><span class="colored_div"></span>';
            ...
            if(!empty($categories)){
                foreach($categories as $cat):
                    ...
                    if($i == 1)
                        $active = 'active';
                    $output .= '<li class="'.$active.'"><a href="#" data-filter=".'.$cat->slug.'">'.$cat->name.'</a></li>';
                endforeach;
            }
            $output .= '</ul>';
        $output .=  '</div>';
            ...
            $output .= '<div class="row">';
          $output .= '<ul class=" blog_filter">';
                        if(!empty($categories)){
                            foreach($categories as $cat):

                        $query_post = array('cat'=> $cat->cat_ID, 'post_type'=> 'post', 'post_status' => 'publish','posts_per_page' => $per_cat,'caller_get_posts'=> 1  );                      
                                ...
                                if(!empty($cat)){
                                    foreach($cat as $c){
                                        $cat_out .= $c->slug.' ';
                                                ...
                                                $output .= '<li class="blog-article '.$size_span_class.'  '.$cat_out.'">';
...
function latest_blog_carousel($element){
    ...
    function recent_news($element){
        ...
        if(!empty($dynamic_title)){
            $output .= '<div class="header"><h6>'.$dynamic_title.'</h6><span class="colored_div"></span>';
            $output .= '</div>';
        ...
        $style = 1;
        if($dynamic_from_where == 'all_cat'){
            $query_post = array('posts_per_page'=> $posts_per_page*$nr_rows, 'post_type'=> 'post' );                          
        }else{
           $query_post = array('posts_per_page'=> $posts_per_page*$nr_rows, 'post_type'=> 'post', 'cat' => $dynamic_cat ); 
        }
            ...
            $output .= '<div class="row">';
                        ...
                        $loop = new WP_Query($query_post);
                                ...
                                $output .= '<dl class="recent_news_post dl-horizontal span'.(12/$posts_per_page).'">';
                                              
                                    $output .= '<dt><img src="'.themeple_image_by_id(get_post_thumbnail_id(), 'recent_post', 'url').'" alt=""></dt>';

                                    $output .= '<dd><h5><a href="'.get_permalink().'">'.get_the_title().'</a></h5><div class="inf"><span class="icon_li"><span class="icon_blog '.$post_format.'"></span></span><h6 class="date">'.get_the_date().'</h6></div></dd>';
                            ...
                            $lim = 10;
                              ...
                              $output .= '<div class="social_widget">'; 
                                ...
                                if(themeple_post_meta(get_the_ID(), 'google_link') != '')
                                    $output .= '<li class="google"><a href="'.themeple_post_meta(get_the_ID(), 'google_link').'" title="Facebook"><i class="moon-google_plus"></i></a></li>';
    ...
    function staff_carousel($element)
    {
        extract($element['saved'][0]);
        $output = '';
       
        $output .= '<div class="span'.$dynamic_size.' carousel_staff_el">';
        if(!empty($title)){
            $output .= '<div class="header"><h6>'.$title.'</h6><span class="colored_div"></span><div class="pagination"></div></div>';
        }                       
        $output .= '<div class="row">';
    ...
    function recent_portfolio($element){
        ...
        $output = '<div class="span'.$dynamic_size.' recent_portfolio '.$classs.' animate_onoffset">';
                        ...
                        $output .= '<div class="row-fluid desc">';
                            $output .= '<div class="span3">';
                                ...
                                if(isset($button_bool) && $button_bool == 'yes'):
                                    $output .= '<a class="button_left_desc readmore" href="'.$button_link.'">'.$button_text.'</a>';
                                endif;
                            $output .= '</div>';
                            $output .= '<div class="span9">';

        endif; 
        $output .= '<section id="portfolio-preview-items" class="row '.$grid.' rows_'.$rows.'">';
        ...
        $themeple_config['dynamic_portfolio']['portfolio_show_desc'] = false;
        if(isset($portfolio_show_desc))
            $themeple_config['dynamic_portfolio']['portfolio_show_desc'] = $portfolio_show_desc;
    ...
    function widget($element){
        ...
        $output = '<div class="span'.$dynamic_size.'">';
        if(!empty($dynamic_title)){
            $output .= '<div class="header"><h6>'.$dynamic_title.'</h6><span class="colored_div"></span></div>';
        }   
        $output .= '<aside>';
   ...
   function home_portfolio ($element){
    ...
    function fullwidth_portfolio($elemnt){
        ...
        if(is_object($item_categories) || is_array($item_categories))
        {
            foreach ($item_categories as $cat)
            {
                ...
                $output .= '<div class="swiper-slide portfolio-item v2  layout-full swiper-slide-visible" style="background-image:url('.themeple_image_by_id(get_post_thumbnail_id(), '4_col_port', 'url').'); background-repeat:no-repeat; -webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover;background-size: cover;">';
                $output .= '    <div class="he-wrap tpl2">';
                $output .= '                       <div class="overlay he-view">';
                 ...
                 $output .= '                                   <a href="'.themeple_image_by_id(get_post_thumbnail_id(), array("width"=> 1200, "height" => 1200), "url").'" class="zoom a1 lightbox-gallery lightbox" data-animate="zoomIn"></a>';
                 $output .= '                               </div>';
                 $output .= '                               <div class="pr_2">';
                 $output .= '                                   <h6>'.$sort_classes.'</h6>';
    ...
    function plain_text($element){
        ...
        if($element_header_bool == 'yes')
            $output .= '<div class="header"><h6>'.$element_title.'</h6><span class="colored_div"></span></div>';
        if($small_title_bool == 'yes')
            $output .= '<h6 class="small_title">'.$small_title.'</h6>';
        if($big_title_bool == 'yes'){
            $extra_style = '';
            if($big_title_color != 'default'){
                $extra_style .= 'color:'.$big_title_color.'; ';
            }
            if($big_title_lineheight != 'default'){
                $extra_style .= 'line-height:'.$big_title_lineheight.'px; ';
            }
            if($big_title_font != 'default'){
                $extra_style .= "font-family:".$big_title_font.'; ';
            }
            $output .= '<h1 class="big_title" style="font-weight:'.$big_title_weight.';font-size:'.$big_title_size.'px; '.$extra_style.'">'.do_shortcode($big_title).'</h1>';
        }
        if($content != '')
            $output .= '<div class="content">'.do_shortcode($content).'</div>';
        if($button_bool == 'yes'){
            $output .= '<a href="'.$button_link.'" class="'.$button_style.'">'.$button_title.'</a>';
        }
    ...
    function toggle($element){
        ...
        if(isset($title) && !empty($title)){      
           $output .= '<div class="header"><h6>'.$title.'</h6>';
            
            $output .= '</div>'; 
        }     
        if(count($toggles) > 0){
            $output .= '<div class="accordion style_1" id="accordion'.$nr.'">';
			$i = 0; 
    ...
    function tabs($element){
        ...
        if(count($tabs) > 0){
            $output .= '<div class="tabbable tabs-top style_1">';
	 ...
	 if(isset($_COOKIE['themeple_skin'])){
        ...
        if(count($skills) > 0){
            foreach($skills as $skill){
                    ...
                    if($skill['color'] == 'base')
                        $skill['color'] = $base;
                    $output .= '<h5 class="skill_title"><span class="big_percentage">'.$skill['percentage_skill'].'%</span>'.$skill['title'].'</h5>';
    ...
    function el_introduction($element){
        extract($element['saved'][0]);
        $output = '<div class="el_intro">';
            if($small_title_top_bool == 'yes')
                $output .= '<h6 class="small_title_top">'.$small_title_top.'</h6>';
            if($big_title_bool == 'yes'){
                $extra_style = '';
                if($big_title_color != 'default')
                    $extra_style .= 'color:'.$big_title_color.'; ';
                ...
                $output .= '<h1 class="big_title" style="font-size:'.$big_title_size.'px; font-weight:'.$big_title_weight.'; '.$extra_style.'">'.do_shortcode($big_title).'</h1>';
            }
            if($divider_bool == 'yes'){
                $extra_style = '';
                if($divider_color != 'default')
                    $extra_style .= 'background:'.$divider_color.'; ';
                $output .= '<div class="divider" style="'.$extra_style.'"></div>';
            }
            if($small_title_bottom_bool == 'yes')
                $output .= '<h6 class="small_title_bottom">'.$small_title_bottom.'</h6>';
            if($first_button_bool == 'yes'){
                $btns_class = '1_btn';
                if($second_button_bool == 'yes') $btns_class = '2_btn';
                $output .= '<div class="btn_wrapper"><div class="buttons '.$btns_class.'">';
                    $extra_style = '';
                    if($button1_bc != 'default'){
                        $extra_style .= 'border:1px solid '.$button1_bc.'; ';
                        $extra_style .= 'color: '.$button1_bc.'; ';
                    }
                    $output .= '<a href="'.$button1_link.'" class="btn-non-bg" style="'.$extra_style.'">'.$button1_title.'</a>';
                    if($second_button_bool == 'yes'){
                        $extra_style = '';
                        if($button2_bc != 'default'){
                            $extra_style .= 'border:1px solid '.$button2_bc.'; ';
                            $extra_style .= 'color: '.$button2_bc.'; ';
                        }
                        $output .= '<a href="'.$button2_link.'" class="btn-non-bg" style="'.$extra_style.'">'.$button2_title.'</a>';
                    }
                $output .= '</div></div>';
            }
        $output .= '</div>';
    ...
    function textbar($element){
        ...
        $output = '<div class="span'.$dynamic_size.' textbar-container">';
                ...
                $extra_style = '';
                if($color != 'default')
                    $extra_style .= 'color:'.$color.'; ';
                $output .= '<h6 style="'.$extra_style.'">'.$small_title.'</h6>';
                if($big_title_bool == 'yes'){
                    $extra_style = '';
                    if($color != 'default')
                        $extra_style .= 'color:'.$color.'; ';
                ...
                if($first_button_bool == 'yes'){
                    ...
                    $output .= '<div class="btn_wrapper"><div class="buttons '.$btns_class.'">';
                        $extra_style = '';
                        if($color != 'default'){
                            $extra_style .= 'border:1px solid '.$color.'; ';
                            $extra_style .= 'color: '.$color.'; ';
                        }
                        $output .= '<a href="'.$button1_link.'" class="'.$button1_style.'" style="'.$extra_style.'">'.$button1_title.'</a>';
                        if($second_button_bool == 'yes'){
                            $extra_style = '';
                            if($color != 'default'){
                                $extra_style .= 'background: '.$color.'; ';
                                $extra_style .= 'color: '.themeple_get_option('base_color').'; ';
                            }
                            $output .= '<a href="'.$button2_link.'" class="'.$button2_style.'" style="'.$extra_style.'">'.$button2_title.'</a>';
                        }
                    $output .= '</div></div>';
                }
    ...
    function services_creative($element){
        extract($element['saved'][0]);
        $output = '<div class="span'.$dynamic_size.' services_creative" style="">';
       
       
         $output .= '<div class="all_medias">';
            $i = 0;
            foreach($list as $l):
                $i++;
                $selected = '';
                if($i == 1)
                    $selected = 'selected';
                $output .= '<img src="'.$l['media'].'" class="'.$selected.'" data-mid="'.$i.'" />';

            endforeach;
            $output .= '</div>';
            
            $output .= '<div class="list_"><div class="wrapper">';
            $i = 0;
            foreach($list as $l):
                $i++;
                $selected = '';
                if($i == 1)
                    $selected = 'selected';
                $output .= '<div class="item '.$selected.'" data-id="'.$i.'"><i class="'.$l['icon'].'"></i><span class="title">'.$l['title'].'</span></div>';
    ...
    function services_small($element){
        ...
        if($icon_bool == 'yes'  && $icon_bool_pred == 'no' && !empty($upload_img)):
               
                $output .= '<img class="upload_img" src="'.$upload_img.'" alt="'.$alt.'" center no-repeat;"/>';
        ...
        $output .= '        ';
        $output .= '    </dt>';
        $output .= '    <dd><h4><a href="'.$data['link'].'">'.$title.'</a></h4><div>'.do_shortcode($data['description']).'</div></dd>';
        $output .= '</dl>';
    ...
    function services_medium($element){
     ...
     function services_medium_box($element){
        extract($element['saved'][0]);
        $output = '<div class="span'.$dynamic_size.' services_medium_box">';
        $icon_class = (($icon_bool == 'yes')?'with_icon':'no_icon');
        $data = array();
        $query = array();
        $data['link'] = '';
        ...
        $output .= '';
            ...
            $output .= '<p>'.do_shortcode($data['description']).'</p>';
            $output .= '<a href="'.get_permalink().'" class="readm">'.__('Read More', 'themeple').'</a>';
        $output .= '</div>';
        $output .= '</div>';
        return $output; 
    }
    ...
    function el_head($element){
	    ...
	    if(!empty($dynamic_title)){
            ...
            $output = '<div class="header '.$extra_class.'" style="'.$extra_style.'"><h6>'.$dynamic_title.'</h6><span class="colored_div"></span>';
    ...
    function media($element){
        extract($element['saved'][0]);
        $some_extra = '';
        if($position_css == 'absolute'){
            if($left_pos != '')
                $some_extra .= 'left:'.$left_pos.'px; ';
            if($right_pos != '')
                $some_extra .= 'right:'.$right_pos.'px; ';
            if($top_pos != '')
                $some_extra .= 'top:'.$top_pos.'px; ';
            if($bottom_pos != '')
                $some_extra .= 'bottom:'.$bottom_pos.'px; ';
            if($width != '')
                $some_extra .= 'width:'.$width.'px; ';
            if($height != '')
                $some_extra .= 'height:'.$height.'px; ';
            $some_extra .= 'position:absolute; ';
        }
        $output = '<div class="span'.$dynamic_size.' media media_el animate_onoffset" style="'.$some_extra.'">';
        $width_style="";
        if($alignment == 'center')
    ...
    function countdown($element){
        extract($element['saved'][0]);
        $output = '<div class="span'.$dynamic_size.' countdown '.$fontcolor.'">';
    ...
    function faq ($element){
        ...
        if(count($categories) > 0){
            $output .='<!-- Portfolio Filter --><nav id="faq-filter" class="span12">';
               $output .= '<span class="title">'.__('Filter', 'themeple').'</span><span class="div"></span>';
               $output .= '<ul class="">';
                 $output .= '<li class="active all"><a href="#"  data-filter="*">'.__('View All', 'themeple').'</a><span></span></li>';
    ...
    $output .= '<div class="accordion faq style_1" id="accordion'.$nr.'">';
